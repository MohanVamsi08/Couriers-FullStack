# Courier Backend with Node

This application allows users to create and maintain a list of couriers that have steps and ingredients. Please visit https://github.com/OC-ComputerScience/courier-frontend for the Vue 3 frontend repository.
...
3. Configure **Apache** to point to **Node** for API requests.
   ...
   ```
   ProxyPass /courierapi http://localhost:3200/courierapi
   ```
...
5. Add a local **.env** file and make sure that the **database** variables are correct.
   ...
   - DB_NAME = '**your-local-database-name**' (example: "courier_db")
